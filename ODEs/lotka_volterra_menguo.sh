...
for nl in "${noise_levels[@]}"; do
    for np in "${data_points[@]}"; do
        ...
        experiment 008 $np $nl 300 --exportto data/lotka_volterra/ex1a  --ensemble  --prior --custom_save "/Users/anthonypoole/Repositories/GP-BayesOpInf/ODEs/mengwu_plots"  # span samples noise regression points
    done
done
