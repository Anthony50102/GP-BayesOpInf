...
for nl in "${noise_levels[@]}"; do
    for np in "${data_points[@]}"; do
        ...
        experiment 008 15 .1 300 --exportto data/lotka_volterra/ex1a  -k 'rbf*cos*rq' --custom_save "/Users/anthonypoole/Repositories/GP-BayesOpInf/ODEs/menguo_plots"  # span samples noise regression points
    done
done
